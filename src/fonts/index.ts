...
export const fontStyles = css`
  @font-face {
    ...
    font-weight: 400;
    font-display: swap;
    src: local('Nunito-Regular'), url(${NunitoWoff2}) format('woff2'), url(${NunitoWoff}) format('woff');
  }
  ...
  @font-face {
    ...
    font-weight: 700;
    font-display: swap;
    src: local('Nunito-Bold'), url(${NunitoBoldWoff2}) format('woff2'), url(${NunitoBoldWoff}) format('woff');
  }
`
