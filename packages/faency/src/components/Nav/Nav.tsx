...
export const NavItem = React.forwardRef<HTMLButtonElement, NavItemProps>(({ ...props }, forwardedRef) => (
  <ButtonPrimitive
    {...props}
    ref={forwardedRef}
    styleConfig={{
...
export const NavGroups = React.forwardRef<HTMLDivElement, NavGroupsProps>(({ children, ...props }, forwardedRef) => {
  const uuid = uuidv4()
...
export const Nav = React.forwardRef<HTMLDivElement, NavProps>(({ children, ...props }, forwardedRef) => {
  return (
